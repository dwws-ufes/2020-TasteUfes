          ...
          <div class="form-group">
                  ...
                  <v-row>
                    ...
                    <v-col cols="12" sm="6" xs="12">
                      <v-select
                        ...
                        item-value="id"
                        :label="
                          this.$vuetify.lang.t('$vuetify.select_a') +
                          ' ' +
                          this.$vuetify.lang.t('$vuetify.measure') +
                          '*'
                        "
                        :rules="[rules.required]"
                        return-value
            ...
            >
              <v-container>
                ...
                <v-row
                  v-if="
                    this.food.nutrition_facts.nutrition_facts_nutrients.length >
                    0
                  "
                >
        ...
        createFood(this.food)
          .then((result) => {
            this.$store.dispatch("setSnackbar", {
              text: `${this.$vuetify.lang.t("$vuetify.ingredient")} ${
                this.food.name
